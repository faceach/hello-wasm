...
if (ENVIRONMENT_IS_NODE) {
  ...
  Module['read'] = function shell_read(filename, binary) {
    var ret;
      if (!nodeFS) nodeFS = require('./node_modules/fs');
      if (!nodePath) nodePath = require('./node_modules/path');
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=STATICTOP; STATICTOP += 16;;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
        ...
        if (typeof crypto !== 'undefined') {
          ...
          // for nodejs
          random_device = function() { return require('./node_modules/crypto')['randomBytes'](1)[0]; };
        } else {
...
if (ENVIRONMENT_IS_NODE) { var fs = require("./node_modules/fs"); var NODEJS_PATH = require("./node_modules/path"); NODEFS.staticInit(); };
